...
class Metaclass_AddThreeInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('mars_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mars_msgs.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from mars_msgs.srv._add_three_ints import AddThreeInts_Request as Request
    from mars_msgs.srv._add_three_ints import AddThreeInts_Response as Response
