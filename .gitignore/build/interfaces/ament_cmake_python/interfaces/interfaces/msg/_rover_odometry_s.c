...
bool interfaces__msg__rover_odometry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._rover_odometry.RoverOdometry", full_classname_dest, 44) == 0);
  }
  interfaces__msg__RoverOdometry * ros_message = _ros_message;
  {  // rover_id
  ...
  {  // linear_velocity
    ...
    if (!geometry_msgs__msg__twist__convert_from_py(field, &ros_message->linear_velocity)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of RoverOdometry */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._rover_odometry");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RoverOdometry");
  ...
  {  // linear_velocity
    PyObject * field = NULL;
    field = geometry_msgs__msg__twist__convert_to_py(&ros_message->linear_velocity);
    if (!field) {
      return NULL;
    }
    {
