...
bool mars_msgs__msg__rover_odometry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mars_msgs.msg._rover_odometry.RoverOdometry", full_classname_dest, 43) == 0);
  }
  mars_msgs__msg__RoverOdometry * ros_message = _ros_message;
  {  // rover_id
...
PyObject * mars_msgs__msg__rover_odometry__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mars_msgs.msg._rover_odometry");
